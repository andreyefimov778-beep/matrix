...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function createTorchSeparator() {
    ...
    sep.innerHTML = `<img class="swords-img" src="assets/swords-divider.png" alt="⚔" />`;
    return sep;
  }
  ...
  // ─── Build Entities ───
  const ENTITY_IMAGES = {
    'АН / АНУ':       'assets/entities/anu.png',
    'ЭНЛИЛЬ':         'assets/entities/enlil.png',
    'ЭНКИ / ЭА':      'assets/entities/enki.png',
    'ИНАННА / ИШТАР': 'assets/entities/inanna.png',
    'МАРДУК':         'assets/entities/marduk.png',
    'НИНХУРСАГ':      'assets/entities/ninhursag.png',
    'ИГИГИ':          'assets/entities/igigi.png',
    'ЛУЛУ':           'assets/entities/lulu.png',
  };

  // ─── Entity Modal ───
  const entityModal = document.getElementById('entity-modal-overlay');
  const entityModalClose = document.getElementById('entity-modal-close');

  function openEntityModal(entity) {
    const imgSrc = ENTITY_IMAGES[entity.name] || '';
    document.getElementById('entity-modal-img').src = imgSrc;
    document.getElementById('entity-modal-img').alt = entity.name;
    document.getElementById('entity-modal-number').textContent = entity.number ? `Код: ${entity.number}` : '';
    document.getElementById('entity-modal-name').textContent = entity.name;
    document.getElementById('entity-modal-role').textContent = entity.role;
    document.getElementById('entity-modal-desc').textContent = entity.desc;
  ...
  function buildEntities() {
    ...
    ENTITIES.forEach(entity => {
      ...
      const avatarHtml = imgSrc
        ? `<img class="entity-avatar" src="${imgSrc}" alt="${entity.name}" />`
